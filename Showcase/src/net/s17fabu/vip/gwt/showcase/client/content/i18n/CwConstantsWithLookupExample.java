...
import net.s17fabu.vip.gwt.showcase.client.ShowcaseConstants;
...
public class CwConstantsWithLookupExample extends ContentWidget {
	...
	public Widget onInitialize() {
		...
		HTML link = new HTML(
				" <a href=\"javascript:void(0);\">ColorConstants</a>");
		...
		linkPanel
				.add(new HTML(constants.cwConstantsWithLookupExampleLinkText()));
		linkPanel.add(link);
		...
		layout
				.setHTML(1, 0, constants
						.cwConstantsWithLookupExampleMethodName());
	...
	private void updateColor() {
		...
		if (key.equals("")) {
			colorResultsBox.setText(constants
					.cwConstantsWithLookupExampleNoInput());
		} else {
			try {
				...
				colorResultsBox.setText(constants
						.cwConstantsWithLookupExampleNoMatches());
			}
		}
	}
}
